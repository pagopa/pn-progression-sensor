...
exports.initTtlSlaTimes = () => {
  const ttlSlaTimes = {
    ...
    ALARM_TTL_PHYSICAL_ADDRESS_LOOKUP_VALIDATION: 0.7,
    ...
    SLA_EXPIRATION_PHYSICAL_ADDRESS_LOOKUP_VALIDATION: 1.4,
  ...
  ttlSlaTimes.ALARM_TTL_PHYSICAL_ADDRESS_LOOKUP_VALIDATION =
    process.env.ALARM_TTL_PHYSICAL_ADDRESS_LOOKUP_VALIDATION ||
    ttlSlaTimes.ALARM_TTL_PHYSICAL_ADDRESS_LOOKUP_VALIDATION;
  ...
  ttlSlaTimes.SLA_EXPIRATION_PHYSICAL_ADDRESS_LOOKUP_VALIDATION =
    process.env.SLA_EXPIRATION_PHYSICAL_ADDRESS_LOOKUP_VALIDATION ||
    ttlSlaTimes.SLA_EXPIRATION_PHYSICAL_ADDRESS_LOOKUP_VALIDATION;
